...
A `.dashrc` file is a YAML configuration file that controls how experiments and comparisons are displayed in the [Dashboard](reference/dashboard-overview.md). Its behavior depends on where it is placed.
