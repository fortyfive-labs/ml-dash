...
def train_simple_model():
    ...
    with Experiment(
        ...
        print(f"✓ Experiment saved to: {experiment.project}/{experiment.name}")
...
- [Logging](reference/guides-logging.md) - Structured logging with levels and metadata
- [Parameters](reference/guides-parameters.md) - Hyperparameter tracking and flattening
- [Metrics](reference/guides-metrics.md) - Time-series metrics tracking
- [Files](reference/guides-files.md) - File upload and management
...
**Getting Started:**
- [Getting Started](reference/get-started-installation.md) - Quick start tutorial
