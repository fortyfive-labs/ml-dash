  ...
  def _print_auth_error(self) -> None:
    ...
    try:
      ...
      message = (
        ...
        "  [cyan]npm install -g @dreamlake/ml-dash[/cyan]  [dim](the CLI ships separately, from npm)[/dim]\n"
      ...
      print("  npm install -g @dreamlake/ml-dash   # the CLI ships separately, from npm")
      print("  ml-dash login\n")
      print("Alternative:")
