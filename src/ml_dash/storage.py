...
class LocalStorage:
  ...
  def create_experiment(
    ...
    # Create full directory structure: project / prefix
    # Note: owner parameter is kept for API compatibility but not used in path.
  ...
  def read_file(
    self, owner: str, project: str, prefix: str, file_id: str, dest_path: Optional[str] = None
  ) -> str:
    """
  ...
  def delete_file(self, owner: str, project: str, prefix: str, file_id: str) -> Dict[str, Any]:
    """
  ...
  def _get_experiment_dir(self, owner: str, project: str, prefix: str) -> Path:
    ...
    Structure: root / project / prefix
    where prefix = folder_1/folder_2/.../exp_name

    Note: owner parameter is kept for API compatibility but not used in path.
    """
    prefix_path = prefix.lstrip("/")
    return self.root_path / project / prefix_path
