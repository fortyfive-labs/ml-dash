...
class TestOptionalMetricName:
    ...
    def test_log_with_explicit_name_still_works(self, local_experiment, temp_project):
        ...
        metric_file = temp_project / getpass.getuser() / "test" / "explicit-name" / "metrics" / "train" / "data.jsonl"
        assert metric_file.exists()
    ...
    def test_multiple_logs_without_name_local(self, local_experiment, temp_project):
        ...
        metric_file = temp_project / getpass.getuser() / "test" / "multi-no-name" / "metrics" / "None" / "data.jsonl"
        assert metric_file.exists()
    ...
    def test_mixed_named_and_none_metrics(self, local_experiment, temp_project):
        ...
        loss_file = temp_project / getpass.getuser() / "test" / "mixed" / "metrics" / "train" / "data.jsonl"
    ...
    def test_multiple_logs_without_name_remote(self, remote_experiment):
        ...
        with remote_experiment(name="multi-no-name-remote", project="test").run as experiment:
            for i in range(10):
...
class TestLogAndFlushMethods:
    ...
    def test_metrics_log_method_local(self, local_experiment, temp_project):
        ...
        metric_file = temp_project / getpass.getuser() / "test" / "log-method" / "metrics" / "train" / "data.jsonl"
        assert metric_file.exists()
    ...
    def test_metrics_log_with_flush_chain_local(self, local_experiment, temp_project):
        ...
        # Check train metrics
        train_file = temp_project / getpass.getuser() / "test" / "log-flush-chain" / "metrics" / "train" / "data.jsonl"
        ...
        none_file = temp_project / getpass.getuser() / "test" / "log-flush-chain" / "metrics" / "None" / "data.jsonl"
        assert none_file.exists()
    ...
    def test_metrics_log_nested_dict_pattern(self, local_experiment, temp_project):
        ...
        # Check train metrics
        train_file = temp_project / getpass.getuser() / "test" / "log-nested" / "metrics" / "train" / "data.jsonl"
        assert train_file.exists()
        ...
        # Check eval metrics
        eval_file = temp_project / getpass.getuser() / "test" / "log-nested" / "metrics" / "eval" / "data.jsonl"
    ...
    def test_metrics_log_with_flush_param(self, local_experiment, temp_project):
        ...
        # Check None metrics
        none_file = temp_project / getpass.getuser() / "test" / "log-flush-param" / "metrics" / "None" / "data.jsonl"
        assert none_file.exists()
    ...
    def test_fluent_method_chaining(self, local_experiment, temp_project):
    ...
    def test_complete_documented_pattern(self, local_experiment, temp_project):
        ...
        # Check train metrics
        train_file = temp_project / getpass.getuser() / "test" / "complete-pattern" / "metrics" / "train" / "data.jsonl"
        with open(train_file) as f:
            train_points = [json.loads(line) for line in f]
        assert len(train_points) == 3

        # Check eval metrics
        eval_file = temp_project / getpass.getuser() / "test" / "complete-pattern" / "metrics" / "eval" / "data.jsonl"
        with open(eval_file) as f:
            eval_points = [json.loads(line) for line in f]
        assert len(eval_points) == 3

        # Check epoch context
        none_file = temp_project / getpass.getuser() / "test" / "complete-pattern" / "metrics" / "None" / "data.jsonl"
        with open(none_file) as f:
            none_points = [json.loads(line) for line in f]
