...
class TestBasicFileOperations:
  ...
  def test_upload_single_file_local(self, local_experiment, sample_files, tmp_proj):
    ...
    with local_experiment("tom/test/file-test").run as experiment:
  ...
  def test_upload_single_file_remote(self, remote_experiment, sample_files):
    ...
    with remote_experiment("tom/test/file-test-remote").run as experiment:
      result = experiment.files("models").upload(
  ...
  def test_upload_multiple_files_local(self, local_experiment, sample_files, tmp_proj):
    ...
    with local_experiment("tom/test/multi-file").run as experiment:
  ...
  def test_upload_multiple_files_remote(self, remote_experiment, sample_files):
    ...
    with remote_experiment("tom/test/multi-file-remote").run as experiment:
      experiment.files("models").upload(sample_files["model"])
      experiment.files("config").upload(sample_files["config"])
...
class TestFileMetadata:
  ...
  def test_file_with_metadata_local(self, local_experiment, sample_files, tmp_proj):
    ...
    with local_experiment("tom/test/file-meta").run as experiment:
  ...
  def test_file_with_metadata_remote(self, remote_experiment, sample_files):
    ...
    with remote_experiment("tom/test/file-meta-remote").run as experiment:
  ...
  def test_file_checksum_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/file-checksum").run as experiment:
  ...
  def test_file_size_metricing_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/file-size").run as experiment:
      result = experiment.files("models").upload(sample_files["model"])
      assert result["sizeBytes"] == model_size

  def test_file_tags_local(self, local_experiment, sample_files, tmp_proj):
    """Test file tagging."""
    with local_experiment("tom/test/file-tags").run as experiment:
...
class TestListFiles:
  ...
  def test_list_files_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/file-list").run as experiment:
      experiment.files("models").upload(sample_files["model"])
      experiment.files("config").upload(sample_files["config"])
  ...
  def test_list_files_remote(self, remote_experiment, sample_files):
    ...
    with remote_experiment("tom/test/file-list-remote").run as experiment:
      experiment.files("models").upload(sample_files["model"])
      experiment.files("config").upload(sample_files["config"])
  ...
  def test_list_empty_files_local(self, local_experiment):
    ...
    with local_experiment("tom/test/no-files").run as experiment:
...
class TestFilePrefixes:
  ...
  def test_file_prefixes_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/file-prefix").run as experiment:
  ...
  def test_nested_prefixes_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/nested-prefix").run as experiment:
  ...
  def test_same_file_different_prefixes_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/same-file-diff-prefix").run as experiment:
      experiment.files("models/v1").upload(sample_files["model"])
...
class TestFileTypes:
  ...
  def test_json_file_upload_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/json-file").run as experiment:
  ...
  def test_csv_file_upload_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/csv-file").run as experiment:
  ...
  def test_binary_file_upload_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/binary-file").run as experiment:
  ...
  def test_large_file_upload_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/large-file").run as experiment:
  ...
  def test_various_file_types_remote(self, remote_experiment, sample_files):
    ...
    with remote_experiment("tom/test/file-types-remote").run as experiment:
      experiment.files("text").upload(sample_files["model"])
...
class TestFileEdgeCases:
  ...
  def test_file_with_spaces_in_name_local(self, local_experiment, tmp_path):
    ...
    with local_experiment("tom/test/spaces-file").run as experiment:
  ...
  def test_file_with_unicode_name_local(self, local_experiment, tmp_path):
    ...
    with local_experiment("tom/test/unicode-file").run as experiment:
  ...
  def test_file_with_long_filename_local(self, local_experiment, tmp_path):
    ...
    with local_experiment("tom/test/long-filename").run as experiment:
  ...
  def test_multiple_uploads_same_file_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/duplicate-upload").run as experiment:
  ...
  def test_file_with_special_characters_local(self, local_experiment, tmp_path):
    ...
    with local_experiment("tom/test/special-chars-file").run as experiment:
  ...
  def test_empty_file_upload_local(self, local_experiment, tmp_path):
    ...
    with local_experiment("tom/test/empty-file").run as experiment:
  ...
  def test_file_with_long_metadata_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/large-file-meta").run as experiment:
      result = experiment.files("models").upload(
  ...
  def test_file_with_many_tags_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/many-tags-file").run as experiment:
  ...
  def test_large_file_remote(self, remote_experiment, sample_files):
    ...
    with remote_experiment("tom/test/large-file-remote").run as experiment:
      result = experiment.files("large").upload(sample_files["large"])
...
class TestFileOrganization:
  ...
  def test_organize_by_type_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/organized").run as experiment:
  ...
  def test_organize_by_version_local(self, local_experiment, sample_files):
    ...
    with local_experiment("tom/test/versioned").run as experiment:
