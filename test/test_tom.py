...
def train_simple_model():
  ...
  with Experiment(
    prefix=f"tom_tao_34833x/tutorials/examples/hyperparameter-schema-test-16",
    ...
    for epoch in range(50):
      ...
      experiment.metrics("validation").log(
        loss=val_loss, accuracy=val_accuracy, perplexity=perplexity, epoch=epoch
      )
      ...
      experiment.metrics("optimization").log(
        learning_rate=current_lr, gradient_norm=gradient_norm, epoch=epoch
      )
