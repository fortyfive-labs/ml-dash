...
class TestBasicParameters:
    ...
    def test_simple_parameters_local(self, local_experiment, temp_project, sample_data):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "params-test" / "parameters.json"
    ...
    def test_parameter_types_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "param-types" / "parameters.json"
        with open(params_file) as f:
...
class TestNestedParameters:
    ...
    def test_nested_parameters_flattening_local(self, local_experiment, temp_project, sample_data):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "nested-params" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_nested_parameters_remote(self, remote_experiment, sample_data):
        ...
        with remote_experiment(name="nested-params-remote", project="test").run as experiment:
            experiment.params.set(**sample_data["nested_params"])
    ...
    def test_deeply_nested_parameters_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "deep-nested" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_mixed_flat_and_nested_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "mixed-params" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
...
class TestParameterUpdates:
    ...
    def test_parameter_update_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "param-update" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_parameter_update_remote(self, remote_experiment):
        ...
        with remote_experiment(name="param-update-remote", project="test").run as experiment:
    ...
    def test_multiple_parameter_updates_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "multi-update" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_overwrite_nested_parameter_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "overwrite-nested" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
...
class TestParameterEdgeCases:
    ...
    def test_empty_parameters_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "no-params" / "parameters.json"
    ...
    def test_parameters_with_special_keys_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "special-keys" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_large_parameter_set_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "large-params" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_very_long_parameter_value_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "long-value" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_unicode_parameter_values_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "unicode-params" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_numeric_edge_values_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "numeric-edge" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_large_parameter_set_remote(self, remote_experiment):
        ...
        with remote_experiment(name="large-params-remote", project="test").run as experiment:
            experiment.params.set(**large_params)
...
class TestParameterCombinations:
    ...
    def test_ml_training_parameters_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "ml-params" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
    ...
    def test_config_file_like_parameters_local(self, local_experiment, temp_project):
        ...
        params_file = temp_project / getpass.getuser() / "test" / "config-params" / "parameters.json"
        with open(params_file) as f:
            params = json.load(f)["data"]
