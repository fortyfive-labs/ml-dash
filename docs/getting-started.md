...
<pre class="terminal"><span class="prompt">$</span> claude <span class="string">"How do I upload experiments to the server?"</span>
...
<span class="dim">With dash_url set, all data syncs automatically.</span></pre>
